...
module ram_block (
    ...
    OR2D1 or_combine0 ( .A1(itag_data[0]), .A2(idata_data[0]), .Z() );
    OR2D1 or_combine1 ( .A1(itag_data[1]), .A2(idata_data[1]), .Z() );
...
module stdcell_alu (
    ...
    // Logic gates
    AN2D1 and_alu0 ( .A1(input[0]), .A2(input[1]), .Z() );
    AN2D1 and_alu1 ( .A1(input[2]), .A2(input[3]), .Z() );
    OR2D1 or_alu0 ( .A1(input[0]), .A2(input[1]), .Z() );
    OR2D1 or_alu1 ( .A1(input[2]), .A2(input[3]), .Z() );
    XOR2D0 xor_alu0 ( .A1(input[0]), .A2(input[1]), .Z() );
    XOR2D0 xor_alu1 ( .A1(input[2]), .A2(input[3]), .Z() );

    // Flip-flops
    DFQD0 ff_alu0 ( .D(input[0]), .CP(clk), .Q(temp[0]) );
    DFQD0 ff_alu1 ( .D(input[1]), .CP(clk), .Q(temp[1]) );
    DFQD0 ff_alu2 ( .D(input[2]), .CP(clk), .Q(temp[2]) );
    DFQD0 ff_alu3 ( .D(input[3]), .CP(clk), .Q(temp[3]) );
...
module stdcell_logic (
    ...
    AN2D1 and_logic0 ( .A1(input[0]), .A2(input[1]), .Z() );
    AN2D1 and_logic1 ( .A1(input[2]), .A2(input[3]), .Z() );
    OR2D1 or_logic0 ( .A1(input[0]), .A2(input[1]), .Z() );
    OR2D1 or_logic1 ( .A1(input[2]), .A2(input[3]), .Z() );
...
module stdcell_decode (
    ...
    INVD1 inv_dec0 ( .I(input[0]), .ZN() );
    INVD1 inv_dec1 ( .I(input[1]), .ZN() );
    BUFFD1 buf_dec0 ( .I(input[0]), .Z() );
    BUFFD1 buf_dec1 ( .I(input[1]), .Z() );
